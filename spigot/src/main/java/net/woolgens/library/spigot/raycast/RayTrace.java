package net.woolgens.library.spigot.raycast;
...
public class RayTrace {
    ...
    //debug / effects
    public void highlight(World world, double blocksAway, double accuracy, Particle particle){
        for(Vector position : traverse(blocksAway,accuracy)){
            world.spawnParticle(particle, position.toLocation(world), 0);
        }
    }
